...
description="虚拟机无法启动并出现错误代码 0xc0000242"
...
Microsoft Azure 已调查完你的虚拟机 (VM) **<!--$vmname-->[vmname]**<!--/$vmname-->。 我们发现，由于 Windows 无法启动并出现错误代码 **0xc0000242**，你的 VM 当前处于不可访问状态。 由于关键的系统驱动程序缺失或包含错误，无法加载操作系统。<br>
<!--/issueDescription-->
