...
* [将 SQL Server 数据库迁移到 Azure VM 中的 SQL Server](https://docs.azure.cn/zh-cn/virtual-machines/windows/sql/virtual-machines-windows-migrate-sql)<br>
...
* [使用 Azure PowerShell 预配 SQL Server 虚拟机 (Resource Manager)](https://docs.azure.cn/zh-cn/virtual-machines/windows/sql/virtual-machines-windows-ps-sql-create)<br>
