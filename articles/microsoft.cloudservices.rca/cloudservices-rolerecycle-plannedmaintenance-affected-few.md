...
从 **[StartTime]<!--($StartTime)--> (UTC)** 到 **[EndTime]<!--($EndTime)--> (UTC)**，角色 **[RoleName]<!--($RoleName)--> 的可用性已受到一定的影响。  在此时间范围内，实例 **[ListRoleInstanceName]<!--($ListRoleInstanceName)--> 已关闭。 这一预期事件由 **Azure 启动的计划内维护操作**所致。  
